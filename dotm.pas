...
function tdotm.getabc(strabc: string): string;
var
...
function tdotm.SbctoDbc(s: string): string;
var
  nlength, i: integer;
...
procedure tdotm.ExecSQL(SQLTEXT: string);
begin
  try
    qrytmp.Close;
    qrytmp.SQL.Clear;
...
procedure tdotm.format_TitleAndANS;
var
  i: integer;
  str1: string;
  r: TPerlRegEx;
...
procedure tdotm.From_ALL_HTMLFILE;
var
  r: TPerlRegEx;
  strall, str2: string;
  i: integer;
...
procedure tdotm.from_ONE_HTMLFILE(htmfile: string);
var
...
function tdotm.MAINPATH: string;
begin
  try
...
procedure tdotm.OpenSQL(SQLTEXT: string);
begin
  try
    qrytmp.Close;
    qrytmp.SQL.Clear;
...
procedure tdotm.TITLE_SPLITTERTO_TitleAndAns;
var
  STRTITLEall: string;
...
destructor tdotm.Destroy;
begin
  CloseTable;
end;

procedure tdotm.tmsaveok;
begin

  tmcon.CommitTrans;
end;

procedure tdotm.tmsavetodb;
begin
  qrytmp.Close;
  qrytmp.SQL.Clear;
...
function tdotm.JPGCount: LongInt;
begin
  result := 1;
  try
...
function tdotm.html_jpg_list(afilename, str: string): string;
var
  str2: string;
  i: integer;
  k: LongInt;
...
function tdotm.clearHTMLBZ(str1: string): string;
var
  r: TPerlRegEx;
  str: string;
begin
...
function tdotm.gettitlename(str: string): string;
var
  pos1: integer;
  len1: Integer;
begin
...
function tdotm.getfilename(str: string): string;
var
  pos1, len1: integer;
begin
  //
...
function tdotm.isalpha(mystr: string): integer;
var
  i: integer;
  strx: string;
  strb: string;
...
function tdotm.inctm(str: string): string;
var
  ii: integer;
begin
  //
...
function tdotm.getimgname(str: string): string;
var
  pos1, len1: integer;
  str1, str2: string;
begin
...
function tdotm.getrightstr(str: string; n: integer): string;
var
  len1: integer;
begin
  //
...
function tdotm.getextname(str: string): string;
var
  pos1, len1: integer;
begin
  //
...
function tdotm.LastPos(SearchStr, Str: string): Integer;
var
  i: Integer;
  TempStr: string;
begin
...
function tdotm.textfromfile(afile: string): string;
var
  txt: TextFile;
  stext, s: string;
  path: string;
...
procedure tdotm.WriteToTEST(ASTR: string);
var
  txt: TextFile;
begin
  try
...
function tdotm.splitstring(src, dec: string): TStringList;
var
  i: integer;
  str: string;
begin
...
procedure tdotm.SendToZJDBF;
begin
  //
end;

function tdotm.getLISTqry: TADOQuery;
//
begin
  QRY_ZJ.close;
  QRY_ZJ.sql.clear;
